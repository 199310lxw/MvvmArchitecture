...
public final class SettingBar extends FrameLayout {
    ...
    public SettingBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mLeftView.setLineSpacing(getResources().getDimension(R.dimen.dimen_size_dp_5), mLeftView.getLineSpacingMultiplier());
        mRightView.setLineSpacing(getResources().getDimension(R.dimen.dimen_size_dp_5), mRightView.getLineSpacingMultiplier());

        mLeftView.setPaddingRelative((int) getResources().getDimension(R.dimen.dimen_size_dp_15),
                (int) getResources().getDimension(R.dimen.dimen_size_dp_12),
                (int) getResources().getDimension(R.dimen.dimen_size_dp_15),
                (int) getResources().getDimension(R.dimen.dimen_size_dp_12));
        mRightView.setPaddingRelative((int) getResources().getDimension(R.dimen.dimen_size_dp_15),
                (int) getResources().getDimension(R.dimen.dimen_size_dp_12),
                (int) getResources().getDimension(R.dimen.dimen_size_dp_15),
                (int) getResources().getDimension(R.dimen.dimen_size_dp_12));
        ...
        setLeftDrawablePadding(array.hasValue(R.styleable.SettingBar_bar_leftDrawablePadding) ?
                ...
                (int) getResources().getDimension(R.dimen.dimen_size_dp_10));
        ...
        // 文字颜色设置
        setLeftTextColor(array.getColor(R.styleable.SettingBar_bar_leftTextColor, ContextCompat.getColor(getContext(), R.color.color_CC000000)));
        setRightTextColor(array.getColor(R.styleable.SettingBar_bar_rightTextColor, ContextCompat.getColor(getContext(), R.color.color_CC000000)));

        // 文字大小设置
        setLeftTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.SettingBar_bar_leftTextSize, (int) getResources().getDimension(R.dimen.dimen_size_sp_15)));
        setRightTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.SettingBar_bar_rightTextSize, (int) getResources().getDimension(R.dimen.dimen_size_sp_14)));
        ...
        if (getBackground() == null) {
            ...
            drawable.addState(new int[]{android.R.attr.state_pressed}, new ColorDrawable(ContextCompat.getColor(getContext(), R.color.color_0D000000)));
            drawable.addState(new int[]{android.R.attr.state_selected}, new ColorDrawable(ContextCompat.getColor(getContext(), R.color.color_0D000000)));
            drawable.addState(new int[]{android.R.attr.state_focused}, new ColorDrawable(ContextCompat.getColor(getContext(), R.color.color_0D000000)));
